...
export function ContractPortfolioCard({ contract, invoices, logo, index, canEdit, canDelete, onView, onEdit, onDelete, preview }: { preview?: ReactNode; contract: Contract; invoices: Invoice[]; logo?: string; index: number; canEdit: boolean; canDelete: boolean; onView: () => void; onEdit: () => void; onDelete: () => void }) {
