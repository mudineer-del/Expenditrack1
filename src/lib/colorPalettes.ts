...
export const PALETTES: Palette[] = [
  ...
  {
    id: "ember", label: "Ember", description: "Warm cream ground with a vibrant orange signal, like a coal glow.", swatch: "#F26A1B",
    light: shared({ background: "#FBF6F1", foreground: "#2A1B0F", card: "#FFFFFF", cardForeground: "#2A1B0F", popover: "#FFFFFF", popoverForeground: "#2A1B0F", primary: "#E8590C", primaryForeground: "#FFFFFF", secondary: "#FBEADD", secondaryForeground: "#8A3D0C", muted: "#F5ECE3", mutedForeground: "#7A6A5C", accent: "#FDE3CC", accentForeground: "#B14D0C", destructive: "#B85D52", border: "#EFDFD0", input: "#EFDFD0", dataviz1: "#E8590C", dataviz2: "#3E8B57", dataviz3: "#C99A3E", dataviz4: "#A45A82", dataviz5: "#4A7A9C", dataviz6: "#8C6A4E", statusCleared: "#4B8A5E", statusUnder: "#C08A3E", statusReturned: "#AE6259", sidebar: "#F7EFE7", sidebarForeground: "#2A1B0F", sidebarPrimaryForeground: "#FFFFFF", sidebarAccent: "#FBE4D2", sidebarAccentForeground: "#B14D0C", sidebarBorder: "#EFDFD0" }),
    dark: shared({ background: "#150E08", foreground: "#FBEEE2", card: "#1E140C", cardForeground: "#FBEEE2", popover: "#241811", popoverForeground: "#FBEEE2", primary: "#FF7A2E", primaryForeground: "#1C0F04", secondary: "#2C1E13", secondaryForeground: "#F0DCC6", muted: "#291C12", mutedForeground: "#BCA692", accent: "#352415", accentForeground: "#FFC79A", destructive: "#DA8B80", border: "#3C2A1C", input: "#4A3423", dataviz1: "#FF7A2E", dataviz2: "#66C285", dataviz3: "#E0B65E", dataviz4: "#C084AC", dataviz5: "#6FA8CC", dataviz6: "#B08863", statusCleared: "#6FAE82", statusUnder: "#D2AC6C", statusReturned: "#CC8880", sidebar: "#18100A", sidebarForeground: "#FBEEE2", sidebarPrimaryForeground: "#1C0F04", sidebarAccent: "#2A1B10", sidebarAccentForeground: "#FFC79A", sidebarBorder: "#3C2A1C" }),
  },
  {
    id: "citron", label: "Citron", description: "Lemon-lime signal on a soft citrus-cream ground.", swatch: "#B4D22E",
    light: shared({ background: "#FAFBF0", foreground: "#22280F", card: "#FFFFFF", cardForeground: "#22280F", popover: "#FFFFFF", popoverForeground: "#22280F", primary: "#6B9411", primaryForeground: "#FFFFFF", secondary: "#EEF2DC", secondaryForeground: "#3C5410", muted: "#F1F4E4", mutedForeground: "#68715A", accent: "#E6EDCE", accentForeground: "#4A6414", destructive: "#B15F52", border: "#DFE6CA", input: "#DFE6CA", dataviz1: "#8FB520", dataviz2: "#3E8BA0", dataviz3: "#D9A23E", dataviz4: "#9C6EA0", dataviz5: "#5C8A46", dataviz6: "#B08A3E", statusCleared: "#4B8A5E", statusUnder: "#B08948", statusReturned: "#AC6058", sidebar: "#F4F7E7", sidebarForeground: "#22280F", sidebarPrimaryForeground: "#FFFFFF", sidebarAccent: "#E9EFD3", sidebarAccentForeground: "#4A6414", sidebarBorder: "#DFE6CA" }),
    dark: shared({ background: "#0F130A", foreground: "#EEF2E0", card: "#161B0F", cardForeground: "#EEF2E0", popover: "#1B2113", popoverForeground: "#EEF2E0", primary: "#A8D93B", primaryForeground: "#131B08", secondary: "#212912", secondaryForeground: "#DDE7C6", muted: "#1D2513", mutedForeground: "#A3B08C", accent: "#293313", accentForeground: "#CBE590", destructive: "#D48981", border: "#2E3A19", input: "#3A4A22", dataviz1: "#A8D93B", dataviz2: "#5FADC2", dataviz3: "#E3B95F", dataviz4: "#BC8BC0", dataviz5: "#7EB86A", dataviz6: "#C6A45F", statusCleared: "#6FAE82", statusUnder: "#C6A56B", statusReturned: "#CC8880", sidebar: "#111509", sidebarForeground: "#EEF2E0", sidebarPrimaryForeground: "#131B08", sidebarAccent: "#232C13", sidebarAccentForeground: "#CBE590", sidebarBorder: "#2E3A19" }),
  },
]
